      ...
      <main className="flex-grow max-w-4xl w-full mx-auto px-6 py-8 md:py-12 z-10 flex flex-col gap-8 text-left">
        ...
        <div className="bg-white border border-zinc-200/60 rounded-[2rem] p-8 md:p-10 shadow-sm flex flex-col gap-6 text-zinc-650 text-sm leading-relaxed font-semibold">
          ...
          <section className="flex flex-col gap-3">
            ...
            <p>
              To start a return request, please contact our helpdesk through the <Link href="/contact" className="text-purple-650 hover:underline">Contact Form</Link> choosing the reason <strong className="text-zinc-800">"Product Inquiries"</strong> or email us at <a href="mailto:pluggedin58@gmail.com" className="text-purple-655 font-bold hover:underline">pluggedin58@gmail.com</a> quoting your order code.
            </p>
          </section>
