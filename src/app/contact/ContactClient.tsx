      ...
      <main className="flex-grow max-w-6xl w-full mx-auto px-6 py-8 md:py-12 z-10 flex flex-col gap-8 md:gap-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {/* Phone Support Card */}
            <div className="bg-white border border-zinc-200/60 rounded-[2rem] p-6 text-left flex gap-4 hover:border-zinc-300 transition-all duration-300 shadow-xs">
              <div className="w-12 h-12 bg-purple-50 border border-purple-100 rounded-full flex items-center justify-center text-purple-655 shrink-0">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white border border-zinc-200/60 rounded-[2.5rem] p-8 md:p-10 shadow-sm relative overflow-hidden text-left min-h-[460px] flex flex-col justify-between">
              ...
              {success ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  <h2 className="text-sm font-bold tracking-wider text-zinc-450 uppercase border-b border-zinc-100 pb-2">
                    Inquiry Form
                  </h2>
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-purple-600 text-white text-sm font-bold tracking-widest py-4 rounded-full hover:bg-purple-755 transition-all duration-300 shadow-md shadow-purple-600/15 cursor-pointer border-0 mt-2 flex items-center justify-center gap-2"
                  >
                    {submitting ? (
        ...
        <div className="mt-12 md:mt-16 flex flex-col gap-6 text-left w-full">
          <div className="flex flex-col gap-1.5">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-zinc-950 font-syne uppercase tracking-tight">
          ...
          <div className="flex flex-col gap-4 mt-2">
            {faqItems.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="border border-zinc-200/60 rounded-2xl overflow-hidden bg-white hover:border-purple-200/60 transition-all duration-300"
                >
                  <button
                    onClick={() => setActiveFaq(isOpen ? null : idx)}
                    className="w-full flex justify-between items-center p-5 text-left font-outfit font-bold text-sm text-zinc-955 hover:text-purple-700 transition-colors duration-200 cursor-pointer border-0 bg-transparent outline-none"
                  >
                    ...
                    <span className={`ml-4 w-7 h-7 rounded-full bg-white border border-zinc-200 flex items-center justify-center shrink-0 transition-all duration-300 shadow-sm ${
                      isOpen ? "rotate-180 text-purple-600 border-purple-200" : "text-zinc-500"
                    }`}>
